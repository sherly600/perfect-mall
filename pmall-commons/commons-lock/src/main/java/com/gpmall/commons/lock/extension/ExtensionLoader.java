package com.pmall.commons.lock.extension;

import com.pmall.commons.lock.extension.annotation.LockSpi;
                                    ...
                                    try {
                                        ...
                                        if (line.length() > 0) {
                                            ...
                                            try {
                                                ...
                                                //name 按都逗号分隔，可以配置多个
                                                //如：redis,redis_1=com.pmall.commons.lock.impl.DistributedRedisLock
