  ...
  <footer>
    ...
    <div id="footer">
      <div class="footer-contert">
        <div class="footer-content-logo"><img src="//cdn.perfectu.com/common/images/nav_logo.png" alt="底部LOGO"> <span>做技术人的指路明灯，职场生涯的精神导师</span>
        </div>
        <div class="footer-content-aboutUs">
          <ul>
            <li>关于我们</li>
            <li><a href="http://www.perfectu.com/about.html?con=xueyjianjie">学院简介</a></li>
            <li><a href="http://www.perfectu.com/about.html?con=lianxiwomen">联系我们</a></li>
            <li><a href="http://www.perfectu.com/partner.html?con=chengpycai20190422">加入我们</a></li>
          </ul>
        </div>
        <div class="footer-content-service">
          <ul>
            <li>服务与支持</li>
            <li><a href="http://www.perfectu.com/partner.html?20190422">讲师招募</a></li>
            <li><a href="http://www.perfectu.com/partner.html?con=shangwuhez20190422">商务合作</a></li>
            <li><a @click="open1()">法律声明</a></li>
          </ul>
        </div>
        <div class="footer-content-img">
          <div class="footer-content-img-wx"><span><img src="//cdn.perfectu.com/common/images/foot-weix.png"
                                                        alt="微信"></span> <span>官方微信</span></div>
          <div class="footer-content-img-wb"><a href="//weibo.com/perfectu?is_hot=1" target="_blank"> <span
            class="weibo"><img src="//cdn.perfectu.com/common/images/foot-web.png" alt="微博"></span> <span>官方微博</span>
          </a></div>
        </div>
      </div>
