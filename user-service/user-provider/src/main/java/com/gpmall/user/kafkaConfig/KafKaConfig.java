package com.pmall.user.kafkaConfig;

import com.pmall.user.dal.entitys.User;
import com.pmall.user.registerVerification.KafKaRegisterSuccConsumerFactory;
import com.pmall.user.registerVerification.KafKaRegisterSuccProducer;
import com.pmall.user.registerVerification.KafKaRegisterSuccProducerFactory;
...
public class KafKaConfig {
    ...
    public KafKaRegisterSuccConsumerFactory kafKaRegisterSuccConsumerFactory(){
        ...
        consumerProperties.put("spring.json.trusted.packages" ,"com.pmall.user.dal.entitys,com.pmall.user.dal.*");
        /*
